...
class PaypalService implements PaypalServiceInterface{
    ...
    /****
    This run_ipn() function will return the verified status that is payment is VERIFIED or NOTVERIFIED. 
    And some correspoding data of the payment.
    ***/
