...
class PaystackService implements PaystackServiceInterface{
    ...
    function set_button(){
        ...
        $receipt="".time()."";
        $paystack_lang = !empty($this->button_lang)?$this->button_lang:__("Paystack Payment");
        ...
        if($this->secondary_button)
        {
			...
			<a href='#' class='list-group-item list-group-item-action flex-column align-items-start' id='paystack_clone' onclick='payWithPaystack();'>
			    <div class='d-flex w-100 align-items-center'>
			      <small class='text-muted'><img class='rounded' width='60' height='60' src='".asset('assets/images/paystack.png')."'></small>
			      <h5 class='mb-1'>".$paystack_lang."</h5>
			    </div>
			</a>";
        }
