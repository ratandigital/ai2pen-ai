...
class UpdateSystem extends Home
{
    ...
    public function update_list()
    {
        ...
        {
            echo "<h2 style='color: red'>".__("Connection failed to establish, cURL is not working! Visit item description page in codecanyon, see change log and update manually.")."</h2>";
            exit();
        }
