...
@section('page-header-title',__('Check Update'))
@section('page-header-details',__('Stay tuned here for updates'))
@section('content')
            ...
            <div class="col-12">
                <div class="card card-rounded mb-4">
                    <div class="card-body card-rounded">
                        ...
                        <p class="card-subtitle card-subtitle-dash">{{__("Update to new versions.")}}</p>

                        <?php
                        if(count($update_versions) > 0) 
                        { ?>       
                            <div class="table-responsive">
                                <table class='table table-select table-sm'>
                        ...
                        { ?>
                         <h4 class="mt-4 text-success"> <?php echo __("No update available, you are already using latest version") ?> <b>v<?php echo $current_version;?></b></h4>
                         <?php          
                        } ?>
