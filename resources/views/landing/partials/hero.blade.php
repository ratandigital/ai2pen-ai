    ...
    <div class="-mx-4 flex flex-wrap items-center">
      <div class="w-full px-3 lg:w-1/2">
        <div class="mx-auto mb-12 max-w-[530px] text-center lg:ml-1 lg:mb-0 lg:text-left">
          <span class="mb-8 inline-block rounded-full bg-primary bg-opacity-5 py-[10px] px-5 font-heading text-base text-primary dark:bg-white dark:bg-opacity-10 dark:text-white" data-wow-delay=".2s">
            <span class="mr-2 inline-block h-2 w-2 rounded-full bg-primary"></span> {{__("Revolutionize Your Content Creation 10x Faster")}} </span>
          <h1 class="wow
            fadeInUp mb-5 font-heading text-2xl font-semibold dark:text-white sm:text-4xl md:text-[500px] md:leading-[60px]" data-wow-delay=".3s"> {{__("Best AI Writer for Creating")}}
            <span class="txt-type" data-wait="3000" data-words='<?php echo $typingKeywords?>'></span>
          </h1>
          <p class="mb-12 text-base text-dark-text" data-wow-delay=".4s"> {{__("Produce exceptional content 10 times faster with our platform. From copywriting and blog articles to SEO content and product descriptions, our tool ensures plagiarism-free and SEO-optimized work. Create emails, ads, and many more with ease.")}}</p>
          <div class="flex flex-wrap items-center justify-center lg:justify-start" data-wow-delay=".5s">
            ...
            <a href="{{$get_landing_language->links_docs_url ?? route('docs')}}" class="inline-flex items-center rounded py-[14px] px-8 font-heading text-base text-dark hover:text-primary dark:text-white dark:hover:text-primary">
              <span class="pr-3">
              ...
              </span> {{__("How it Work")}} </a>
          </div>
        </div>
      </div>
      <div class="w-full px-4 lg:w-1/2">
        <div class="wow fadeInRight relative z-30 mx-auto h-[560px] w-full max-w-[700px] lg:ml-0" data-wow-delay=".3s">
          <div class="absolute cs-video-block right-0 z-10">
            <video autoplay muted loop>
              <source src="{{$get_landing_language->header_image??asset('assets/landing/video/intro.mp4')}}" type="video/mp4">
            </video>
