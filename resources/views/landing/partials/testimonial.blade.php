          ...
          <div class="-mx-4 flex flex-wrap items-center">
            <div class="order-last w-full px-4 lg:order-first lg:w-2/3">
              <div class="text-center lg:text-left">
                ...
                <p class="text-base text-dark-text"> '.display_landing_content($get_landing_language->$var4).' </p>
              </div>
            </div>
            <div class="w-full px-4 lg:w-1/3">
              <div class="lg:mr-0 relative mx-auto mb-9 h-[420px] w-full max-w-[420px] lg:mb-0">
                <div class="absolute right-5 cs-top-1/3 z-10">
                  <img src="'.$get_landing_language->$var2.'" class="cs-testimonial-image" alt="testimonial-image" />
                  <div class="absolute -right-5 -top-5 -z-10 h-full w-full border border-primary border-opacity-10 bg-primary bg-opacity-5 backdrop-blur-[6px] dark:border-white dark:border-opacity-10 dark:bg-white dark:bg-opacity-10"></div>
                </div>
              </div>
            </div>
          </div>
