  ...
  <div class="px-4 pt-24 xl:container">
    <div class="border-b pb-20 dark:border-[#2E333D] lg:pb-[130px]">
        ...
        <p class="mb-12 text-base text-dark-text">
          {!! __('By accessing or using <a href=":appurl">:appurl</a> you represent that you have the full authority to act to bind yourself, any third party, company, or legal entity, and that your use and/or interaction, as well as continuing to use or interact, with the website constitutes your having read and agreed to these terms of use as well as other agreements that we may post on the website.',['appurl'=>url('/')])!!}

          {!! __('By viewing, visiting, using, or interacting with this website or with any banner, pop-up, or advertising that appears on it, you are agreeing to all the provisions of this terms of use policy as well as the <a href=":privacypolicyurl">privacy policy</a> and <a href=":refundpolicyurl">refund policy</a> of this website.',['privacypolicyurl'=>route('policy-privacy'),'refundpolicyurl'=>route('policy-refund')])!!}
