...
@push('scripts-header')
    ...
    <style>.dropzone .dz-message{margin:2.4em !important}</style>
@endpush
@section('content')
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="form-group">
              ...
              <input type="number" name="paid-amount" id="paid-amount" class="form-control form-control-lg" min="1">
          ...
          <div class="col-lg-6 mb-4">
            <div class="form-group">
              ...
              {!!
                  Form::select("paid-currency",$currency_list,$currency,['id' => 'paid-currency', 'class' => 'form-control form-control-lg select2','style'=>'width:100%'])
              !!}
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div id="manual-payment-dropzone" class="dropzone mb-1">
                <div class="dz-default dz-message">
                  <input class="form-control form-control-lg" name="uploaded-file" id="uploaded-file" type="hidden">
          ...
          <div class="col-lg-12">
            <div class="form-group">
              ...
              &nbsp;
              <textarea name="additional-info" id="additional-info" class="form-control form-control-lg"></textarea>
            </div>
          </div>
        </div>
      </div><!-- ends modal-body -->
      ...
      <div class="modal-footer bg-whitesmoke br d-block">
        <button type="button" id="manual-payment-submit" class="btn btn-primary m-0"><i class="fas fa-save"></i> <?php echo __('Submit'); ?></button>
