...
@section('page-header-title',__('Payment Settings'))
@section('page-header-details',__('All your payment integrations in one place'))
@push("styles-header")
...
@section('content')
    <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12 col-lg-4">
                    <div class="card card-rounded mb-4 p-lg-2">
                        <div class="card-body card-rounded">
                            <h4 class="card-title  card-title-dash">{{__('Currency')}}</h4>
                            <p class="card-subtitle card-subtitle-dash mb-2 mb-lg-4">{{__("Set payment preferences")}}</p>
                            <?php
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::select('currency',get_country_iso_phone_currency_list('currency_name'),old('currency', $currency),array('class'=>'form-control form-control-lg select2'));?>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::select('currency_position',['left'=>__('Left'),'right'=>__('Right')],old('currency_position', $currency_position),array('class'=>'form-control form-control-lg'));?>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="decimal_point" id="decimal_point" min="0" class="form-control form-control-lg" value="{{old('decimal_point',$decimal_point)}}">
                ...
                <div class="col-12 col-lg-8">
                    <div class="card card-rounded mb-4 p-lg-2 mb-4">
                        <div class="card-body card-rounded">
                            <h4 class="card-title  card-title-dash">{{__('Payment Method')}}</h4>
                            <p class="card-subtitle card-subtitle-dash mb-2 mb-lg-4">{{__("Manager your payment methods")}}</p>
                            <div class="row">
                                <div class="col-8">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="paypal_client_id" value="{{old('paypal_client_id',$paypal_client_id)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="paypal_client_secret" value="{{old('paypal_client_secret',$paypal_client_secret)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-text pt-4 w-100">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" id="paypal_payment_type" name="paypal_payment_type" type="checkbox" value="recurring" checked>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="stripe_secret_key" value="{{old('stripe_secret_key',$stripe_secret_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="stripe_publishable_key" value="{{old('stripe_publishable_key',$stripe_publishable_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="yoomoney_shop_id" value="{{old('yoomoney_shop_id',$yoomoney_shop_id)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="yoomoney_secret_key" value="{{old('yoomoney_secret_key',$yoomoney_secret_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="razorpay_key_id" value="{{old('razorpay_key_id',$razorpay_key_id)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="razorpay_key_secret" value="{{old('razorpay_key_secret',$razorpay_key_secret)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="paystack_secret_key" value="{{old('paystack_secret_key',$paystack_secret_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="paystack_public_key" value="{{old('paystack_public_key',$paystack_public_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="mercadopago_public_key" value="{{old('mercadopago_public_key',$mercadopago_public_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="mercadopago_access_token" value="{{old('mercadopago_access_token',$mercadopago_access_token)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                ...
                                                                <?php echo Form::select('mercadopago_country',get_marcadopago_country_list(),old('mercadopago_country', $mercadopago_country),array('class'=>'form-control form-control-lg'));?>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="mollie_api_key" value="{{old('mollie_api_key',$mollie_api_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="sslcommerz_store_id" value="{{old('sslcommerz_store_id',$sslcommerz_store_id)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="sslcommerz_store_password" value="{{old('sslcommerz_store_password',$sslcommerz_store_password)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="senangpay_merchent_id" value="{{old('senangpay_merchent_id',$senangpay_merchent_id)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="senangpay_secret_key" value="{{old('senangpay_secret_key',$senangpay_secret_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="instamojo_api_key" value="{{old('instamojo_api_key',$instamojo_api_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="instamojo_auth_token" value="{{old('instamojo_auth_token',$instamojo_auth_token)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="toyyibpay_secret_key" value="{{old('toyyibpay_secret_key',$toyyibpay_secret_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="toyyibpay_category_code" value="{{old('toyyibpay_category_code',$toyyibpay_category_code)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="xendit_secret_api_key" value="{{old('xendit_secret_api_key',$xendit_secret_api_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="myfatoorah_api_key" value="{{old('myfatoorah_api_key',$myfatoorah_api_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="paymaya_public_key" value="{{old('paymaya_public_key',$paymaya_public_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fab fa-keycdn"></i></span>
                                                            <input name="paymaya_secret_key" value="{{old('paymaya_secret_key',$paymaya_secret_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="flutterwave_api_key" value="{{old('flutterwave_api_key',$flutterwave_api_key)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                ...
                                <div class="col-4 custom-nav-pills">
                                    <div class="nav d-block nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        @endif
                                        <a class="nav-link <?php if(check_build_version()!='double') echo 'active';?>" data-bs-toggle="pill" href="#manual-block" role="tab" aria-controls="" aria-selected="true">{{__('Manual')}}</a >
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row <?php if(check_build_version()!='double') echo 'd-none';?>">
            <div class="col-12">
                <div class="card card-rounded mb-4 p-lg-2">
                    <div class="card-body card-rounded">
                        <div class="d-sm-flex justify-content-between align-items-start">
                            <div>
                                <h4 class="card-title card-title-dash">{{__('Payment API Log')}}</h4>
                                <p class="card-subtitle card-subtitle-dash mb-2 mb-lg-4">{{__("List of all payment api calls")}}</p>
                            </div>
