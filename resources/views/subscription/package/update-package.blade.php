...
@section('page-header-details',__('Update existing access level'))
@section('content')
                ...
                <div class="col-12 col-md-7">
                    ...
                    <div class="card card-rounded mb-4 p-lg-2">
                        <div class="card-body card-rounded">
                            ...
                            <input name="is_default" value="{{$xdata->is_default}}"  class="form-control form-control-lg" type="hidden">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="name">{{ $action_type=='team' ? __("Team Role Name") : __("Subscription Package Name") }} *</label>
                                        <input name="package_name"  class="form-control form-control-lg" type="text" value="{{old('package_name',$xdata->package_name)}}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            @if($xdata->is_default=="1")
                                                <select name="price" id="price_default" class="form-control form-control-lg">
                                            ...
                                            @else
                                                <input name="price"  class="form-control form-control-lg" type="text" value="{{old('price',$xdata->price)}}">
                                ...
                                <div class="col-12 col-md-6" >
                                    <div class="form-group hidden_me">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="validity" name="validity" class="form-control form-control-lg" value="{{old('validity',$validity_amount)}}">
                                            <?php echo Form::select('validity_type',$validity_types,old('validity_type',$validity_type),array('class'=>'form-control form-control-lg')); ?>
                                        </div>
                                            ...
                                            @foreach($modules as $module)
                                                ...
                                                <tr class="border-0">
                                                    ...
                                                    if($module->id==$module_id_team_member){
                                                        ...
                                                        if(!$is_admin && $xmonthly_val==0) $xmonthly_val = 10;
                                                    }
                                                    ?>
                                                    <td class='text-center w-min-250px {{$action_type=="team" ? "d-none" : ""}}'>
                                                        <div class="input-group {{$input_group_class}}">
                                                            ...
                                                            <input type='number' {{$disabled}} class='form-control form-control-lg {{$styleClass}}' value='{{$xmonthly_val}}' min='{{$min_limit}}' max="{{$max_limit}}" name='monthly_{{$module->id}}'>
                                                    ...
                                                    <td class='text-center w-min-250px {{$action_type=="team" ? "d-none" : ""}}'>
                                                        <div class="input-group {{$input_group_class}}">
                                                            ...
                                                            <input type='number' {{$disabled}} class='form-control form-control-lg {{$styleClass}}' value='{{$xbulk_val}}' min='0' name='bulk_{{$module->id}}'>
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="tab-content p-0 border-0" id="v-pills-tabContent">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" name="discount_percent" class="form-control form-control-lg" value="{{old('discount_percent',$discount_data->percent??'')}}">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="discount_terms" class="form-control form-control-lg" value="{{old('discount_terms',$discount_data->terms??'')}}">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="discount_start_date" class="form-control form-control-lg datetimepicker" value="{{old('discount_start_date',$discount_data->start_date??'')}}">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                                            <input type="text" name="discount_end_date" class="form-control form-control-lg datetimepicker" value="{{old('discount_end_date',$discount_data->end_date??'')}}">
                                        ...
                                        <div class="tab-pane fade" id="fastspring-block" role="tabpanel" aria-labelledby="">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="name"> {{ __("FastSpring Product Path") }}</label>
                                                        <input type="text" name="fastspring_product_id" class="form-control form-control-lg" value="{{old('fastspring_product_id',$product_data->fastspring->product_id??'')}}">
                                                        @if ($errors->has('fastspring_product_id'))
                                                            <span class="text-danger"> {{ $errors->first('fastspring_product_id') }} </span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="name"> {{ __("FastSpring Coupon") }}</label>
                                                        <input type="text" name="fastspring_coupon" class="form-control form-control-lg" value="{{old('fastspring_coupon',$product_data->fastspring->coupon??'')}}">
                                                        @if ($errors->has('fastspring_coupon'))
                                                            <span class="text-danger"> {{ $errors->first('fastspring_coupon') }} </span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="paypro-block" role="tabpanel" aria-labelledby="">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="name"> {{ __("PayPro Product ID") }}</label>
                                                        <input type="text" name="paypro_product_id" class="form-control form-control-lg" value="{{old('paypro_product_id',$product_data->paypro->product_id??'')}}">
                                                        @if ($errors->has('paypro_product_id'))
                                                            <span class="text-danger"> {{ $errors->first('paypro_product_id') }} </span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="name"> {{ __("PayPro Coupon") }}</label>
                                                        <input type="text" name="paypro_coupon" class="form-control form-control-lg" value="{{old('paypro_coupon',$product_data->paypro->coupon??'')}}">
                                                        @if ($errors->has('paypro_coupon'))
                                                            <span class="text-danger"> {{ $errors->first('paypro_coupon') }} </span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="paypal_plan_id" class="form-control form-control-lg" value="{{old('paypal_plan_id',$product_data->paypal->plan_id??'')}}">
