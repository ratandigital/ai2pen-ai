        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-5/12 xl:w-5/12">
            <div class="mb-20 max-w-[330px]">
              ...
              <p class="mb-10 text-base text-dark-text"> {{__("Produce content for your blogs, advertisements, emails, and website that is both search engine optimized and free of plagiarism, all while increasing your speed by a factor of 10.")}} </p>
